...
namespace Hadoop.Conf.Tools
{
    public class Serializer<T>
    {
            ...
            else
            {
                ...
                using (MemoryStream stream = new MemoryStream())
                {
                    if (stream.CanWrite)
                    {
                        ...
                        {
                            serializer.Serialize(writer.BaseStream, o, ns);
        ...
        public string SerializeJson(T o)
        {
            string result = string.Empty;

            //System.Web.Script.Serialization.JavaScriptSerializer json = new System.Web.Script.Serialization.JavaScriptSerializer();

            //result = new System.Web.Script.Serialization.JavaScriptSerializer().Serialize(o);
        ...
        public T DeserializeJson(string s)
        {
            T result = default(T);
